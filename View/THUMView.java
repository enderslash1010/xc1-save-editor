...
public class THUMView extends JPanel {
	...
	public THUMView(GUI gui) {
		...
		gui.setTextField(SaveField.nameString, THUMName, new StringFilter(32));
		...
		gui.setCheckBox(SaveField.ngPlusFlag, THUMNgPlusCheckBox);
		THUMNGPanel.add(THUMNgPlusCheckBox, "alignx left,aligny top");

		JCheckBox THUMSystemSaveCheckBox = new JCheckBox("System Save");
		gui.setCheckBox(SaveField.systemSaveFlag, THUMSystemSaveCheckBox);
		...
		gui.setComboBox(SaveField.picSlot1, THUMPicSlot1);
		...
		gui.setComboBox(SaveField.picSlot2, THUMPicSlot2);
		...
		gui.setComboBox(SaveField.picSlot3, THUMPicSlot3);
		...
		gui.setComboBox(SaveField.picSlot4, THUMPicSlot4);
		...
		gui.setComboBox(SaveField.picSlot5, THUMPicSlot5);
		...
		gui.setComboBox(SaveField.picSlot6, THUMPicSlot6);
		...
		gui.setComboBox(SaveField.picSlot7, THUMPicSlot7);
